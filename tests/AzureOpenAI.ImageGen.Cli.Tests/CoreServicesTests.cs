...
public class CoreServicesTests
{
    ...
    [Fact]
    public void Slugify_CreatesStableFriendlyNames()
    {
        string slug = FileOutputService.Slugify("A dramatic portrait, neon-lit!");

        Assert.Equal("a-dramatic-portrait-neon-lit", slug);
    }
